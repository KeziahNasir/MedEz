    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-checks ba-check-first">
          <FaCircleCheck style={{ color: "#1E8FFD" }} /> Best Professional
          Doctors
        </p>
        <p className="ba-checks">
          <FaCircleCheck style={{ color: "#1E8FFD" }} /> Emergency Care
        </p>
        <p className="ba-checks">
          <FaCircleCheck style={{ color: "#1E8FFD" }} /> 24/7 Support Live Chat
        </p>
        <p className="ba-checks ba-check-last">
          <FaCircleCheck style={{ color: "#1E8FFD" }} /> Enrollment Easy and
          Quick
        </p>
