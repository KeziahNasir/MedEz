    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to MedEz, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using MedEz, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          MedEz is designed to simplify healthcare access. You can choose
